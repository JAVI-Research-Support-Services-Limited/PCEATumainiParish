...
export default function EmmanuelWorship() {
  return (
          ...
          <div className="@container">
            <div className="@[480px]:p-4 p-0">
              <div
                ...
                style={{
                  backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.7) 100%), url("https://images.unsplash.com/photo-1523050335456-adabbf72c766?auto=format&fit=crop&q=80&w=1600")`,
                }}
              >
