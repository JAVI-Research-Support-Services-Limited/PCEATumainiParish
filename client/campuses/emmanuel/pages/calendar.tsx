  ...
  return (
    <div className="py-20 bg-white">
      <div className="mx-auto w-[90%] max-w-[1246px]">
        <h1 className="font-display text-3xl md:text-4xl font-bold mb-8">Calendar of Events</h1>
                ...
                <div className="p-8 relative">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="flex items-center gap-3">
                      <img src="https://cdn.prod.website-files.com/60df60bf8a21e72645df37b0/60dfb3480bb6ad22468ac9ef_icon-1-date-church-x-template.svg" alt="date" className="w-5 h-5" />
                      <span className="text-sm">{e.date}</span>
                    </div>
                    <div className="h-px bg-gray-200 w-6" />
                    <div className="flex items-center gap-3">
                      <img src="https://cdn.prod.website-files.com/60df60bf8a21e72645df37b0/60dfb3489b2e9d6df9a228f5_icon-2-date-church-x-template.svg" alt="time" className="w-5 h-5" />
                  ...
                  <div className="uppercase font-semibold text-sm tracking-wide">Register to event</div>
                  <div className="mt-3 bg-gray-200 h-2 w-full overflow-hidden">
                    <div className="bg-black h-2 w-0" style={{ width: '0%' }} />
                  </div>
                </div>
              </div>
            </a>
