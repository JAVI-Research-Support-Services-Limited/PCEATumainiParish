...
export default function EmmanuelGive() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-end">
            <Button asChild className="font-sans ml-auto">
              <Link to="/emmanuel">Back to Church</Link>
            </Button>
          </div>
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
        ...
        <section className="text-center space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gray-100 text-gray-700 text-xs font-sans font-bold border border-gray-200">
            ...
            2024 EMMANUEL CHURCH TRANSPARENCY
          </div>
          ...
          <p className="max-w-2xl mx-auto text-gray-600 text-lg font-sans leading-relaxed">
            Discover how our Emmanuel community is actively engaging and
            contributing towards our shared mission and development goals this
            year.
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {GOALS.map((goal) => {
            ...
            return (
              <div
                key={goal.id}
                className="bg-white p-7 rounded-xl shadow-sm border border-gray-200 relative group hover:shadow-md transition-all"
              >
                ...
                <div className="flex items-baseline gap-2 mb-4">
                  <span className="text-3xl font-sans font-extrabold text-gray-900">
                    KES {goal.current.toLocaleString()}
                  </span>
                  <span className="text-sm font-sans font-semibold text-gray-500">
                    of {Math.round(goal.goal / 1000)}k goal
                  </span>
                </div>

                <div className="w-full bg-gray-100 rounded-full h-1.5 mb-3 overflow-hidden">
                  <div
                    className="bg-[#c05621] h-full rounded-full transition-all duration-1000 ease-out"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-sm font-sans font-bold text-gray-600 uppercase tracking-wider">
                    Contributors
                  </span>
                </div>
                <div className="text-3xl font-sans font-extrabold text-gray-900 mb-1">
                  280
                </div>
                <div className="text-xs font-sans font-semibold text-green-600">
                  6% vs last month
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                ...
                <div className="text-xs font-sans font-semibold text-gray-500">
                  Tithe & Offering
                </div>
              </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm sticky top-6">
              <h3 className="text-xl font-display text-gray-900 mb-6">
                Make a Contribution
              </h3>

              {showSuccess && (
                <div className="mb-6 p-5 bg-[#003366] border-l-4 border-[#c05621] rounded-lg shadow-md animate-in fade-in zoom-in-95 duration-300">
                  <div className="flex items-center gap-3 text-white">
                    <span className="material-icons text-2xl text-[#c05621]">
                      verified
                    </span>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm font-sans font-bold text-gray-900 mb-2">
                    Full Name
                  </label>
                  <input
                    required
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-center gap-2 bg-[#003366] text-white py-4 rounded-lg font-sans font-bold text-base shadow-lg transition-all ${
                    isProcessing
        ...
        {/* Scripture Quote */}
        <section className="bg-gradient-to-br from-[#003366]/5 to-[#003366]/10 p-12 rounded-2xl border border-[#003366]/20 text-center">
          <span className="material-icons text-5xl text-[#c05621]/40 mb-6 block">
            format_quote
          </span>
          ...
          <cite className="text-base font-sans font-bold text-gray-600 uppercase tracking-wider">
            2 Corinthians 9:7
          </cite>
        </section>
      </main>
