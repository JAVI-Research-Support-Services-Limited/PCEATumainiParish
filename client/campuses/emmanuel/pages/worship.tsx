    ...
    <header className="relative h-screen flex items-center justify-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-12 animate-fade-up">
        <h1 className="font-['Abril_Fatface'] text-5xl md:text-7xl lg:text-8xl text-white font-light mb-8 tracking-tight leading-tight">
          Seek peace and <br />
          <span className="italic text-navy-900 font-normal">discover faith.</span>
        </h1>
        <p className="text-gray-200 text-base md:text-lg font-light tracking-wide mb-12 max-w-2xl mx-auto leading-relaxed opacity-90 font-['Montserrat']">
          Welcome to a space of reflection and spiritual renewal. Join us as we journey together in worship, learning, and prayer.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href="#latest-sermons"
            className="inline-block bg-black hover:bg-navy-900 text-white px-10 py-5 rounded-lg text-xs font-bold uppercase tracking-[0.2em] transition-all duration-300 shadow-xl transform hover:-translate-y-1 font-['Montserrat']"
          >
            Begin Your Journey
          </a>
        </div>
...
const SermonCard: React.FC<Sermon> = ({ series, title, info, img }) => (
  <div className="group bg-white rounded-xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 border border-gray-200">
    ...
    <div className="p-8">
      <span className="text-navy-900 text-[10px] font-bold uppercase tracking-widest block mb-2 font-['Montserrat']">{series}</span>
      <h3 className="font-['Abril_Fatface'] text-2xl text-black mb-2 italic">{title}</h3>
      <p className="text-gray-600 text-xs mb-6 font-light font-['Montserrat']">{info}</p>
      <a href="#" className="inline-flex items-center text-navy-900 text-[10px] font-bold uppercase tracking-[0.2em] hover:text-black transition-all group/link font-['Montserrat']">
        Watch Now 
    ...
    <section className="py-32 bg-white" id="latest-sermons">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <span className="text-navy-900 text-xs font-bold uppercase tracking-[0.3em] mb-4 block font-['Montserrat']">Weekly Messages</span>
          <h2 className="font-['Abril_Fatface'] text-4xl md:text-5xl text-black font-light">Latest Sermons</h2>
...
const ProgressBar: React.FC<{ label: string; progress: number }> = ({ label, progress }) => (
  <div className="mb-10">
    <div className="flex justify-between items-end mb-3">
      <span className="text-black font-['Abril_Fatface'] text-xl tracking-wide">{label}</span>
      <span className="text-navy-900 text-[10px] font-bold tracking-[0.2em] font-['Montserrat']">{progress}% COMPLETE</span>
    </div>
    <div className="w-full h-[1px] bg-gray-200 overflow-hidden">
      <div 
        className="bg-navy-900 h-full transition-all duration-[2000ms] ease-out" 
...
const Ministries: React.FC = () => {
  ...
  return (
    <section className="py-32 bg-gray-50 border-y border-gray-200" id="ministries">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
          <div>
            <h2 className="font-['Abril_Fatface'] text-3xl md:text-4xl text-black mb-8 italic">Bible Study Groups</h2>
            <p className="text-gray-600 font-light mb-12 leading-relaxed max-w-lg font-['Montserrat']">
              Join our active groups as we navigate through the Word together. Track our progress in each seasonal study as we dive deep into scripture.
            </p>
            ...
            <div className="mt-14">
              <a href="#" className="inline-flex items-center text-navy-900 text-[10px] font-bold uppercase tracking-[0.3em] hover:text-black transition-all group font-['Montserrat']">
                Explore All Groups 
          ...
          <div id="contact" className="bg-white p-10 md:p-14 rounded-2xl border border-gray-200 shadow-2xl relative">
            <h2 className="font-['Abril_Fatface'] text-3xl text-black mb-4 italic">Prayer Requests</h2>
            <p className="text-gray-600 text-sm font-light mb-10 leading-relaxed font-['Montserrat']">
              How can we support you in prayer this week? All requests are handled with confidentiality and care by our pastoral team.
            </p>
            ...
            {submitted ? (
              <div className="h-64 flex flex-col items-center justify-center text-center">
                ...
                <h4 className="text-black font-['Abril_Fatface'] text-2xl mb-2">Request Received</h4>
                <p className="text-gray-600 text-sm font-['Montserrat']">We are holding you in our prayers.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-8">
                <div>
                  <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-navy-900 mb-3 font-['Montserrat']" htmlFor="name">
                    Full Name
                  </label>
                  <input
                    required
                ...
                <div>
                  <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-navy-900 mb-3 font-['Montserrat']" htmlFor="request">
                    Your Prayer Request
                  </label>
                  <textarea
                    required
                ...
                <button
                  className="w-full bg-black hover:bg-navy-900 text-white py-5 rounded-lg text-[10px] font-bold uppercase tracking-[0.3em] transition-all duration-300 shadow-lg transform active:scale-95 font-['Montserrat']"
                  type="submit"
                >
...
const ValueBlock: React.FC<{
  ...
  <div className={`relative min-h-[450px] group overflow-hidden border-r border-b border-gray-200 flex flex-col justify-end p-10 ${!bgImg ? 'bg-white' : ''}`}>
    {bgImg && (
      <>
        <img
          alt={title}
    ...
    <div className="relative z-10 transition-transform duration-500 group-hover:-translate-y-4">
      ...
      <h3 className="font-['Abril_Fatface'] text-3xl text-black mb-6 tracking-wide italic">{title}</h3>
  ...
  return (
    <section className="relative bg-white overflow-hidden">
      <div className="absolute top-0 left-0 p-8 md:p-16 z-20 pointer-events-none">
        <h2 className="font-['Abril_Fatface'] text-4xl md:text-5xl text-black/90">Our Values</h2>
      </div>
