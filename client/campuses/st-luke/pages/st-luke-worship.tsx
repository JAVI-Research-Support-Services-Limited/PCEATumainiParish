...
export default function StLukeWorship() {
  return (
          ...
          <div className="@container">
            <div className="@[480px]:p-4 p-0">
              <div
                ...
                style={{
                  backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.7) 100%), url("https://images.unsplash.com/photo-1438232992991-995b7058bbb3?auto=format&fit=crop&q=80&w=1600")`,
                }}
              >
