      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
        ...
        <section className="text-center space-y-6">
          ...
          <p className="max-w-2xl mx-auto text-gray-600 text-lg font-sans leading-relaxed">
            Discover how our Mwihoko community is actively engaging and contributing towards our shared mission and development goals this year.
          </p>
        </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            <h2 className="text-2xl font-display text-gray-900">Mwihoko Church Performance</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                ...
                <div className="text-3xl font-sans font-extrabold text-gray-900 mb-1">324</div>
                <div className="text-xs font-sans font-semibold text-green-600">8% vs last month</div>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                ...
                <div className="text-3xl font-sans font-extrabold text-gray-900 mb-1">KES 58,200</div>
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                ...
                <div className="text-3xl font-sans font-extrabold text-gray-900 mb-1">KES 52,500</div>
