            ...
            <div className="container mx-auto px-4 md:px-8 lg:px-16 max-w-7xl">
              <div className="max-w-2xl">
                ...
                <p className="text-white text-sm md:text-base mb-4">
                  Join us in worship, fellowship, and service as we grow
                  together in faith
                </p>
                <p className="text-white text-xs md:text-sm mb-6">{verseRef}</p>
                  ...
                  {showDropdown ? (
                    <div className="relative z-20">
                      <button
                        ...
                        className="flex items-center gap-2 px-6 py-3.5 bg-[#003366] border border-white rounded text-white text-sm hover:bg-white hover:text-[#003366] transition-colors"
                      >
                        Explore Your Parish
                        <svg
                          width="12"
                      ...
                      {isDropdownOpen && (
                        <div className="absolute top-full mt-2 w-full flex flex-col bg-[#003366] rounded overflow-hidden shadow-lg z-30 border border-white/20">
                          <button
                    ...
                    <>
                      <button
                        ...
                        className="px-6 py-3.5 bg-[#003366] border border-white rounded text-white text-sm hover:bg-white hover:text-[#003366] transition-colors"
                      >
                        Join Us In Person
                      </button>
                      <button
                        onClick={() => scrollToSection("video")}
                        className="px-6 py-3.5 bg-transparent border border-white rounded text-white text-sm hover:bg-white hover:text-[#003366] transition-colors"
                      >
                        Join Us Online
                      </button>
                    </>
