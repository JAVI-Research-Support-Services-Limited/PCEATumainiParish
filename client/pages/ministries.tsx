...
const ministries = [
  ...
  },
  {
    ...
    subtitle: "One Love",
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuDMDqyAOcZEN2tkm4JyRgkiH_hHGOALX6oc6IK65e5K6nD_aSKU2Bgss19TrpvzO5B0NBvBgo2rWumQZEoZ8GzTbGauu6bDgn2DBN2oP__vsLqmtNrdXAhTk3By30YK-JZrPyrb0wtxo7JGmyiI3w5tx_umk0TSIEFm81wm9LI4q2o1nzwEuexoJlGkmyByZcA8-h3yDmCE1V0xdiHxoxG-6PlsgUPse3n1rDNU3G51Hd0z6Ddhc0F-MWI-aKn1w0ABmXeYBOf6e48",
    position: "bottom"
  },
  {
    id: "women",
    title: "Women's Guild",
    subtitle: "Beautiful",
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCKfHPWvLok8H72-B3iBsg0f6xXkboo56t77Gjzf2s2kcR7K-3SVNVRy5_wan2R-LHsKBsCzt1jHZpMgcyF11XJl0dIU3Xo4L5mGlRQMN4pufDRKpthaXWsaPOsN4ecaEaBD28-I9yCPYD2euoeUkH6aaqg3NA2u0RErO_QE6mj4rihcevvDhD9adKDXHzuFDfnoiGzldfCCeO26VvD2fgw8Hjp-1y_VF9b1VKpncqPTbIwcX3Ux47S3iKPIZXVLXSv2rhHkSaOWI0",
    position: "center",
    large: true
  },
  {
    ...
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCqQkmV0y4YgI9vsi_v8-xcKjHhNdUQ1gN1vgKc1zNrfqP1X9sZcdi_W5tEBqt2LmGCp5v37lQjPnnrJWV2zaqIZK8KJa9uSI0S0yRmoYU_dxOhNF9f-ocb-oh70Z6odilYWY_2AQw2ABOvx9t_GzMyLleyKg3Co3fBtL2xqDDOKC3zWfgJ2K2_vz2MbuyD_dqfI3p2epDhvzq8QIpkHIsHwPii6CqIAZLZHdnlf6QYYAEaKgmrofLUAPI8r8ypl-viL4-h0LsavpQ",
    position: "center"
  },
  {
    id: "brigade",
    ...
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuASJxv14W5RnfgVUJ4SjsUIGVqf6yP93lR6-HjZrFHBsVCl9iwicHjIPhj-WUt7jFVMzlg9U3C9TlxtkpgJVUURnlYuL5oS81bq5PEMCcTcYt68WjI2S67wDPgoE9Qo5j1aOtv-G3lMstm9PWjgH8w9dXuTUqJbmy3yya3xZMxpdPmOQr9sA3sFk9ubCbx1ZQk_BUxDCf7CFGKH1WWlWExxh_6gwYrPwsCBosrDqEhILrodoeCp3lZ-FdCjR6dREXaB1AUMJSBtFwI",
    position: "bottom"
  },
  {
    id: "evangelism",
    title: "Evangelism",
    subtitle: "Español",
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBPQWMy7sBT2NMcFv_ntNn2isM47QvHtAFO8SYz3qfl3uUsWzE5823hnyaS93EbuRX24IbbmHTTKbPjjnuklMKGbSX8Ke0iZEQ3Q4YZKGTpwPteEX3AT1pEV4nZHFiDtTFh-nObtMHiRTQq7MdJ14MXBGIiGdgf5TCTtnK0fgFmRwzBox0MxjdD5umN5rQJCFa3Q-FR97f5E-No22IlW9qf_N2F8nN_qnf9Kx6zxvfgxo5NJr_nA4QLoHWn2BgPdilVfBHf-wUEZzs",
    position: "bottom"
  }
];
...
const callToActionCards = [
  {
    id: "spheres",
    title: "Learn how to serve the kingdom in the sphere God has called you to.",
    subtitle: "Spheres"
  },
  {
    id: "serve",
    title: "Join the team and become a part of our community.",
    subtitle: "Serve"
  }
];
      ...
      <main className="max-w-[1400px] mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div
                className={`absolute inset-0 flex flex-col items-center text-center px-6 ministry-overlay ${
                  ministry.position === "center" ? "justify-center" : "justify-end pb-12"
                }`}
              >
                ...
                <h3
                  className={`text-white font-bold mb-6 uppercase ${
                    ministry.large ? "text-4xl md:text-5xl font-black tracking-tighter" : "text-3xl"
                  }`}
                >
                  {ministry.title}
                </h3>
          ...
          {callToActionCards.map((card) => (
            <div
              key={card.id}
              className="bg-gray-500 dark:bg-zinc-800 h-[500px] flex flex-col items-center justify-center text-center px-12 group hover:bg-gray-600 transition-colors"
            >
              <p className="text-white text-xs tracking-[0.2em] mb-4 uppercase opacity-80 font-bold">
                {card.subtitle}
              </p>
              <h3 className="text-white text-xl md:text-2xl font-bold uppercase leading-tight tracking-tight max-w-md">
                {card.title}
              </h3>
            </div>
          ))}
